...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 13, 2018 at 08:20 PM
...
CREATE TABLE IF NOT EXISTS `ecal_calendar` (
  ...
  `EventTitle` varchar(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ums_permission` (
  ...
  PRIMARY KEY (`TableID`)
) ENGINE=InnoDB AUTO_INCREMENT=3789 DEFAULT CHARSET=latin1;
...
(3665, 'COURSE_C', 'COURSE_C', 'COURSE'),
(3666, 'COURSE_R', 'COURSE_R', 'COURSE'),
(3667, 'COURSE_U', 'COURSE_U', 'COURSE'),
(3668, 'COURSE_D', 'COURSE_D', 'COURSE'),
(3669, 'COURSE_TYPE_C', 'COURSE_TYPE_C', 'COURSE TYPE'),
(3670, 'COURSE_TYPE_R', 'COURSE_TYPE_R', 'COURSE TYPE'),
(3671, 'COURSE_TYPE_U', 'COURSE_TYPE_U', 'COURSE TYPE'),
(3672, 'COURSE_TYPE_D', 'COURSE_TYPE_D', 'COURSE TYPE'),
(3673, 'COURSE_SESSIONAL_TYPE_C', 'COURSE_SESSIONAL_TYPE_C', 'COURSE SESSIONAL TYPE'),
(3674, 'COURSE_SESSIONAL_TYPE_R', 'COURSE_SESSIONAL_TYPE_R', 'COURSE SESSIONAL TYPE'),
(3675, 'COURSE_SESSIONAL_TYPE_U', 'COURSE_SESSIONAL_TYPE_U', 'COURSE SESSIONAL TYPE'),
(3676, 'COURSE_SESSIONAL_TYPE_D', 'COURSE_SESSIONAL_TYPE_D', 'COURSE SESSIONAL TYPE'),
(3677, 'CLUB_C', 'CLUB_C', 'CLUB'),
(3678, 'CLUB_R', 'CLUB_R', 'CLUB'),
(3679, 'CLUB_U', 'CLUB_U', 'CLUB'),
(3680, 'CLUB_D', 'CLUB_D', 'CLUB'),
(3681, 'DISCUSSION_C', 'DISCUSSION_C', 'DISCUSSION'),
(3682, 'DISCUSSION_R', 'DISCUSSION_R', 'DISCUSSION'),
(3683, 'DISCUSSION_U', 'DISCUSSION_U', 'DISCUSSION'),
(3684, 'DISCUSSION_D', 'DISCUSSION_D', 'DISCUSSION'),
(3685, 'DISCUSSION_CAT_C', 'DISCUSSION_CAT_C', 'DISCUSSION CATEGORY'),
(3686, 'DISCUSSION_CAT_R', 'DISCUSSION_CAT_R', 'DISCUSSION CATEGORY'),
(3687, 'DISCUSSION_CAT_U', 'DISCUSSION_CAT_U', 'DISCUSSION CATEGORY'),
(3688, 'DISCUSSION_CAT_D', 'DISCUSSION_CAT_D', 'DISCUSSION CATEGORY'),
(3689, 'DISCUSSION_COMMENT_C', 'DISCUSSION_COMMENT_C', 'DISCUSSION COMMENT'),
(3690, 'DISCUSSION_COMMENT_R', 'DISCUSSION_COMMENT_R', 'DISCUSSION COMMENT'),
(3691, 'DISCUSSION_COMMENT_U', 'DISCUSSION_COMMENT_U', 'DISCUSSION COMMENT'),
(3692, 'DISCUSSION_COMMENT_D', 'DISCUSSION_COMMENT_D', 'DISCUSSION COMMENT'),
(3693, 'DISCIPLINE_C', 'DISCIPLINE_C', 'DISCIPLINE'),
(3694, 'DISCIPLINE_R', 'DISCIPLINE_R', 'DISCIPLINE'),
(3695, 'DISCIPLINE_U', 'DISCIPLINE_U', 'DISCIPLINE'),
(3696, 'DISCIPLINE_D', 'DISCIPLINE_D', 'DISCIPLINE'),
(3697, 'FILE_C', 'FILE_C', 'FILE'),
(3698, 'FILE_R', 'FILE_R', 'FILE'),
(3699, 'FILE_U', 'FILE_U', 'FILE'),
(3700, 'FILE_D', 'FILE_D', 'FILE'),
(3701, 'PERMISSION_C', 'PERMISSION_C', 'PERMISSION'),
(3702, 'PERMISSION_R', 'PERMISSION_R', 'PERMISSION'),
(3703, 'PERMISSION_U', 'PERMISSION_U', 'PERMISSION'),
(3704, 'PERMISSION_D', 'PERMISSION_D', 'PERMISSION'),
(3705, 'POSITION_C', 'POSITION_C', 'POSITION'),
(3706, 'POSITION_R', 'POSITION_R', 'POSITION'),
(3707, 'POSITION_U', 'POSITION_U', 'POSITION'),
(3708, 'POSITION_D', 'POSITION_D', 'POSITION'),
(3709, 'PROJECT_C', 'PROJECT_C', 'PROJECT'),
(3710, 'PROJECT_R', 'PROJECT_R', 'PROJECT'),
(3711, 'PROJECT_U', 'PROJECT_U', 'PROJECT'),
(3712, 'PROJECT_D', 'PROJECT_D', 'PROJECT'),
(3713, 'QUESTION_C', 'QUESTION_C', 'QUESTION'),
(3714, 'QUESTION_R', 'QUESTION_R', 'QUESTION'),
(3715, 'QUESTION_U', 'QUESTION_U', 'QUESTION'),
(3716, 'QUESTION_D', 'QUESTION_D', 'QUESTION'),
(3717, 'REGISTRATION_C', 'REGISTRATION_C', 'REGISTRATION'),
(3718, 'REGISTRATION_R', 'REGISTRATION_R', 'REGISTRATION'),
(3719, 'REGISTRATION_U', 'REGISTRATION_U', 'REGISTRATION'),
(3720, 'REGISTRATION_D', 'REGISTRATION_D', 'REGISTRATION'),
(3721, 'RESULT_C', 'RESULT_C', 'RESULT'),
(3722, 'RESULT_R', 'RESULT_R', 'RESULT'),
(3723, 'RESULT_U', 'RESULT_U', 'RESULT'),
(3724, 'RESULT_D', 'RESULT_D', 'RESULT'),
(3725, 'ATTENDANCE_C', 'ATTENDANCE_C', 'ATTENDANCE'),
(3726, 'ATTENDANCE_R', 'ATTENDANCE_R', 'ATTENDANCE'),
(3727, 'ATTENDANCE_U', 'ATTENDANCE_U', 'ATTENDANCE'),
(3728, 'ATTENDANCE_D', 'ATTENDANCE_D', 'ATTENDANCE'),
(3729, 'MARKS_SETUP_C', 'MARKS_SETUP_C', 'MARKS_SETUP'),
(3730, 'MARKS_SETUP_R', 'MARKS_SETUP_R', 'MARKS_SETUP'),
(3731, 'MARKS_SETUP_U', 'MARKS_SETUP_U', 'MARKS_SETUP'),
(3732, 'MARKS_SETUP_D', 'MARKS_SETUP_D', 'MARKS_SETUP'),
(3733, 'GRADE_SETUP_C', 'GRADE_SETUP_C', 'GRADE_SETUP'),
(3734, 'GRADE_SETUP_R', 'GRADE_SETUP_R', 'GRADE_SETUP'),
(3735, 'GRADE_SETUP_U', 'GRADE_SETUP_U', 'GRADE_SETUP'),
(3736, 'GRADE_SETUP_D', 'GRADE_SETUP_D', 'GRADE_SETUP'),
(3737, 'ROLE_C', 'ROLE_C', 'ROLE'),
(3738, 'ROLE_R', 'ROLE_R', 'ROLE'),
(3739, 'ROLE_U', 'ROLE_U', 'ROLE'),
(3740, 'ROLE_D', 'ROLE_D', 'ROLE'),
(3741, 'SCHOOL_C', 'SCHOOL_C', 'SCHOOL'),
(3742, 'SCHOOL_R', 'SCHOOL_R', 'SCHOOL'),
(3743, 'SCHOOL_U', 'SCHOOL_U', 'SCHOOL'),
(3744, 'SCHOOL_D', 'SCHOOL_D', 'SCHOOL'),
(3745, 'SESSION_C', 'SESSION_C', 'SESSION'),
(3746, 'SESSION_R', 'SESSION_R', 'SESSION'),
(3747, 'SESSION_U', 'SESSION_U', 'SESSION'),
(3748, 'SESSION_D', 'SESSION_D', 'SESSION'),
(3749, 'SURVEY_C', 'SURVEY_C', 'SURVEY'),
(3750, 'SURVEY_R', 'SURVEY_R', 'SURVEY'),
(3751, 'SURVEY_U', 'SURVEY_U', 'SURVEY'),
(3752, 'SURVEY_D', 'SURVEY_D', 'SURVEY'),
(3753, 'SURVEY_QUESTION_C', 'SURVEY_QUESTION_C', 'SURVEY QUESTION'),
(3754, 'SURVEY_QUESTION_R', 'SURVEY_QUESTION_R', 'SURVEY QUESTION'),
(3755, 'SURVEY_QUESTION_U', 'SURVEY_QUESTION_U', 'SURVEY QUESTION'),
(3756, 'SURVEY_QUESTION_D', 'SURVEY_QUESTION_D', 'SURVEY QUESTION'),
(3757, 'SURVEY_QUESTION_TYPE_C', 'SURVEY_QUESTION_TYPE_C', 'SURVEY QUESTION TYPE'),
(3758, 'SURVEY_QUESTION_TYPE_R', 'SURVEY_QUESTION_TYPE_R', 'SURVEY QUESTION TYPE'),
(3759, 'SURVEY_QUESTION_TYPE_U', 'SURVEY_QUESTION_TYPE_U', 'SURVEY QUESTION TYPE'),
(3760, 'SURVEY_QUESTION_TYPE_D', 'SURVEY_QUESTION_TYPE_D', 'SURVEY QUESTION TYPE'),
(3761, 'SURVEY_QUESTION_FILLUP_C', 'SURVEY_QUESTION_FILLUP_C', 'SURVEY QUESTION FILLUP'),
(3762, 'SURVEY_QUESTION_FILLUP_R', 'SURVEY_QUESTION_FILLUP_R', 'SURVEY QUESTION FILLUP'),
(3763, 'SURVEY_QUESTION_FILLUP_U', 'SURVEY_QUESTION_FILLUP_U', 'SURVEY QUESTION FILLUP'),
(3764, 'SURVEY_QUESTION_FILLUP_D', 'SURVEY_QUESTION_FILLUP_D', 'SURVEY QUESTION FILLUP'),
(3765, 'TERM_C', 'TERM_C', 'TERM'),
(3766, 'TERM_R', 'TERM_R', 'TERM'),
(3767, 'TERM_U', 'TERM_U', 'TERM'),
(3768, 'TERM_D', 'TERM_D', 'TERM'),
(3769, 'USER_C', 'USER_C', 'USER'),
(3770, 'USER_R', 'USER_R', 'USER'),
(3771, 'USER_U', 'USER_U', 'USER'),
(3772, 'USER_D', 'USER_D', 'USER'),
(3773, 'YEAR_C', 'YEAR_C', 'YEAR'),
(3774, 'YEAR_R', 'YEAR_R', 'YEAR'),
(3775, 'YEAR_U', 'YEAR_U', 'YEAR'),
(3776, 'YEAR_D', 'YEAR_D', 'YEAR'),
(3777, 'VIDEO_C', 'VIDEO_C', 'VIDEO'),
(3778, 'VIDEO_R', 'VIDEO_R', 'VIDEO'),
(3779, 'VIDEO_U', 'VIDEO_U', 'VIDEO'),
(3780, 'VIDEO_D', 'VIDEO_D', 'VIDEO'),
(3781, 'VIDEO_COMMENT_C', 'VIDEO_COMMENT_C', 'VIDEO COMMENT'),
(3782, 'VIDEO_COMMENT_R', 'VIDEO_COMMENT_R', 'VIDEO COMMENT'),
(3783, 'VIDEO_COMMENT_U', 'VIDEO_COMMENT_U', 'VIDEO COMMENT'),
(3784, 'VIDEO_COMMENT_D', 'VIDEO_COMMENT_D', 'VIDEO COMMENT'),
(3785, 'CALENDAR_C', 'CALENDAR_C', 'CALENDAR'),
(3786, 'CALENDAR_R', 'CALENDAR_R', 'CALENDAR'),
(3787, 'CALENDAR_U', 'CALENDAR_U', 'CALENDAR'),
(3788, 'CALENDAR_D', 'CALENDAR_D', 'CALENDAR');
